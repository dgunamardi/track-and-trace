...
func (s *SmartContract) AddTNTData(ctx contractapi.TransactionContextInterface, key string, accountID string, eventData string) (string, error) {
	ctx.GetStub().PutState(key, []byte(eventData))
...
// AddCTEwithAsset record event data into a transaction
func (s *SmartContract) AddIMPData(ctx contractapi.TransactionContextInterface, key string, accountID string, importData string) (string, error) {
